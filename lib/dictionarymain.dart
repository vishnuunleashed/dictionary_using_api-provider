...
//
//     final dictionaryMain = dictionaryMainFromJson(jsonString);

import 'dart:convert';

List<DictionaryMain> dictionaryMainFromJson(String str) => List<DictionaryMain>.from(json.decode(str).map((x) => DictionaryMain.fromJson(x)));

String dictionaryMainToJson(List<DictionaryMain> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class DictionaryMain {
  ...
  factory DictionaryMain.fromJson(Map<String, dynamic> json) => DictionaryMain(
    word: json["word"],
